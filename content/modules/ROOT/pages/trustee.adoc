...
image::/showroom/repo/content/modules/ROOT/assets/images/trustee.png[link=self, window=blank]
...
image::/showroom/repo/content/modules/ROOT/assets/images/workflow.png[link=self, window=blank]
