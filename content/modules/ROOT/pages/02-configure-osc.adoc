...
In order to create the xref:02-configure-osc.adoc#pp-cm[peer-pods configmap], it is necessary to have Trustee installed and xref:02-configure-trustee.adoc#trustee-route[configured].
...
Check the nodes after they have been updated:
...
The output should be sinmilar to this:
